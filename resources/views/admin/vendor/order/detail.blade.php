                    ...
                    @if ($order->is_order_handle_by_admin)
                        <div class="row" style="display: flex; justify-content: center;">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                ...
                                <a href="{{ route('admin.vendor.order.print.pdf', $order->id) }}">
...
@section('script')
    <script>
            ...
            function handleClickOrTouchstatusChange(event) {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            var token = $("meta[name='csrf-token']").attr("content");
                            var url = "{{ url('/admin/vendor/order/change') }}" + '/' + status + '/' + id;
                            $.ajax({
                                url: url,
                                type: 'GET',
                                dataType: 'json',
        ...
        function submitApproval() {
            ...
            let url = "{{ url('/admin/vendor/order/approve') }}";
