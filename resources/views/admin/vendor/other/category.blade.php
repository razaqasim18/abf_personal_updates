                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <button id="addModalbutton" type="button" class="btn btn-primary">Add Category</a>
                                </div>
                            </div>
                            <div class="card-body">
                                @if (session('success'))
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button data-id=" {{ $row->id }}"
                                                            data-category=" {{ $row->category }}" id="editCategory"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel" id="modeltitle">Add Category Detail</h5>
                    ...
                    <form id="addForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <input id="category" type="text"
                                class="col-sm-8 form-control @error('category') is-invalid @enderror" name="category"
...
@section('script')
    ...
    <script>
        ...
        function submitApproval() {
            ...
            let url = "{{ url('/admin/vendor/category/save') }}";
            var form = $('#addForm')[0];
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            var url = '{{ url('/admin/vendor/category/delete') }}' + '/' + id;
                            $.ajax({
                                url: url,
                                type: 'DELETE',
                                dataType: 'json',
