            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal form-bordered" id="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.insert') }}">
                                @csrf
                                @if (session('success'))
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="brand_id" id="brand_id">
                                            ...
                                            <option value="{{ $row->id }}" @if (old('brand_id')==$row->id) selected @endif>
                                                {{ $row->brand }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="category_id" id="category_id">
                                            ...
                                            <option value="{{ $row->id }}" @if (old('category_id')==$row->id) selected @endif>
                                                {{ $row->category }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <span class="text-danger">*</span>
                                        <input type="text" class="form-control" name="product" id="product" value="{{ old('product') }}" required>
                                        @error('product')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <span class="text-danger">*</span>
                                        <input type="number" class="form-control" name="points" id="points" value="{{ old('points') }}" required>
                                        @error('points')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" min="0" class="form-control" name="price" id="price" step=".01" value="{{ old('price') }}" required="">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <span class="text-danger">*</span>
                                        <div class="input-group">
                                            <input type="number" min="0" class="form-control" name="purchase_price" id="purchase_price" step=".01" value="{{ old('purchase_price') }}" required="">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    PKR
                                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <span class="text-danger">*</span>
                                        <div class="input-group">
                                            <input type="number" min="0" class="form-control" name="stock" id="stock" value="{{ old('stock') }}" required="">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    Unit
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input" type="checkbox" id="is_stock" name="is_stock" value="1" {{ old('is_stock') == '1' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <span class="text-danger">*</span>
                                        <div class="input-group">
                                            <input type="number" min="0" class="form-control" name="discount" id="discount" value="{{ old('discount') }}" required="">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    %
                                                </div>
                                        ...
                                        <div class="form-group mt-2 mb-0">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input" type="checkbox" id="is_discount" name="is_discount" value="1" {{ old('is_discount') == '1' ? 'checked' : '' }}>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" min="0" class="form-control" name="weight" id="weight" value="{{ old('weight') }}" step="0.001">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    Kg
                                                </div>
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="file" name="file[]" type="file" class="form-control" accept="image/png, image/gif, image/jpeg, image/jpg" multiple>
                                        </div>
                                        @error('file')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row mt-2">
                                            <div class="col-md-12">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="checkbox" id="is_feature" name="is_feature" value="1" {{ old('is_feature') == '1' ? 'checked' : '' }}>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-row mt-2">
                                            <div class="col-md-12">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="radio" id="is_other2" name="is_other" value="0" checked>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="form-row mt-2">
                                            <div class="col-md-12">
                                                <div class="custom-control custom-checkbox">
                                                    <input class="custom-control-input" type="radio" id="is_other1" name="is_other" value="1">
