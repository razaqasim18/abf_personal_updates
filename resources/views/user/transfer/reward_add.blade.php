                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4>Wallet to Reward Fund Transfer</h4>
                            </div>
                            <div class="card-body">
                                @if (session('success'))
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pr-0 pt-3">
                                        <form method="POST" action="{{ route('transfer.reward.insert') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" min="0" step=".01" max="{!! CustomHelper::getUserWalletAmountByid(Auth::user()->id) !!}"
