                                            ...
                                            @foreach ($order as $row)
                                                <tr>
                                                    ...
                                                    <td style="display: grid;">
                                                        ...
                                                        <a href="{{ route('vendor.order.detail', $row->id) }}"
                                                            class="btn btn-sm btn-primary">
                                                            <i class="far fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('vendor.order.print.pdf', $row->id) }}"
                                                        ...
                                                        @if (!$row->is_order_handle_by_admin)
                                                            ...
                                                            <button id="deleteButton" data-id="{{ $row->id }}"
                                                                href="{{ route('vendor.order.delete', $row->id) }}"
...
@section('script')
    ...
    <script>
        ...
        function submitApproval() {
            ...
            let url = "{{ url('/vendor/order/change/delivery') }}";
