                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 pr-0 pt-3">
                                        <form method="POST" action="{{ route('vendor.withdraw.insert') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group row mb-1">
                                                <h4 class="col-6">Balance in Wallet:</h4>
                                                <h2 class="col-6 text-right text-primary">
                                                    {!! CustomHelper::getVendorWalletAmountByid(Auth::user()->id) !!}
                                                    </h5>
                                            </div>
                                            ...
                                            <span class="col-sm-12 pl-0 pr-0 mt-3 text-danger">
                                                <strong>Note:
                                                    {{ SettingHelper::getSettingValueBySLug('vendor_transection_charges') }}%
